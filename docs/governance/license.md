...
This template is distributed under the [MIT License](https://github.com/HYP3R00T/devcontainer-template/blob/main/LICENSE).
...
1. Decide whether the new project should remain under MIT.
2. If it remains MIT, review the year and copyright holder for the new project.
3. If another license is required, replace the template license before distribution.
4. Confirm that dependencies, copied material, assets, and generated content are compatible with the selected license.
5. Mention the selected license in the project README and keep the complete license text at the repository root.
